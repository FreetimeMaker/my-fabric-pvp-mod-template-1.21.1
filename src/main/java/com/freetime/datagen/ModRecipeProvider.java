...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        offerSmelting(exporter, BLOOD_INGOT_SMELTABLES, RecipeCategory.MISC, ModItems.BLOOD_INGOT, 0.25f, 200, "pvp_mod");
        offerBlasting(exporter, BLOOD_INGOT_SMELTABLES, RecipeCategory.MISC, ModItems.BLOOD_INGOT, 0.25f, 100, "pvp_mod");
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.BLOOD_INGOT, 9)
                .input(ModBlocks.BLOOD_BLOCK)
                .criterion(hasItem(ModBlocks.BLOOD_BLOCK), conditionsFromItem(ModBlocks.BLOOD_BLOCK))
                .offerTo(exporter);
    }
}