...
import com.freetime.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.BLOOD_INGOT_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.STRENGTH, 400, 2, false, false),
                                    new StatusEffectInstance(StatusEffects.HEALTH_BOOST, 400, 1, false, false),
                                    new StatusEffectInstance(StatusEffects.NIGHT_VISION, 400, 0, false, false))).build();
